...
// FIXME: Very bad :(
const std::string_view psfilename = "hello";
...
inline std::string invalidArgsErrorMessage(std::vector<Interpreter::DataType> expected_types, std::vector<Interpreter::DataType> actual_types) {
    std::stringstream msg;
...
InvalidArgsError::InvalidArgsError(const Token &token, const Context &context, std::vector<Interpreter::DataType> &&expected_types, std::vector<Interpreter::DataType> &&actual_types)
